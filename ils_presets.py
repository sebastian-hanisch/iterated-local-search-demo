...
SETTING_SPECS = {
    ...
    "n_bridges_slider": SettingSpec("nb", int, C.DEFAULT_N_BRIDGES, C.N_BRIDGES_MIN, C.N_BRIDGES_MAX),
    "accept_select": SettingSpec("acc", _choice(C.ACCEPT_LABELS), C.DEFAULT_ACCEPT),
...
PRESET_KEYS = {"n": "n_slider", "ballung": "ballung_slider", "seed": "seed_input", "local_search": "local_search_select", "n_bridges": "n_bridges_slider",
               "accept": "accept_select", "budget": "budget_select", "start": "start_radio", "chain_seed": "chain_seed_input"}
