"""Kandidatenlisten + Don't-Look-Bits fuer 2-opt: derselbe Zug wie in ils_tour, aber statt nach jedem Zug
...
def dlb_descend(D, start, cand, seed=0, max_evaluations=None, touched=None):
    ...
    Kandidatenpaar (c1, c2) - dieselbe Einheit wie 'bewertete Nachbarn' im vollen Abstieg (ils_tour.descend).
