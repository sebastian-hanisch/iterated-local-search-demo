"""Doppelbrücken-Zug (ils_kick.double_bridge): gültige Permutation, kein No-op, und die eigentliche Pointe - durch keinen einzelnen
2-opt-Zug rückgängig zu machen (erschöpfend gegen alle 2-opt-Züge auf kleinen Instanzen geprüft, nicht nur behauptet)."""

import numpy as np
import pytest

from ils_kick import double_bridge
