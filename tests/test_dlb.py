"""Wortgleiche Kopie aus der simulated-annealing-demo (tests/test_dlb.py), an ils_dlb.py/ils_tour.py angepasst; ergänzt um Tests für den neuen `touched`-Kurzweg (test_dlb_touched_*).

Kandidatenlisten + Don't-Look-Bits (ils_dlb.py): Permutation, Laengenbuchhaltung, Monotonie, Determinismus,
Bewertungsbudget; bei kleinen Instanzen echte 2-opt-Optima (gegen ils_tour.is_local_optimum, unabhaengig von
